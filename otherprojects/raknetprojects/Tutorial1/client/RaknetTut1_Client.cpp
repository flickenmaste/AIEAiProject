...
RaknetTut1_Client::RaknetTut1_Client()
{
...
bool RaknetTut1_Client::onCreate(int a_argc, char* a_argv[]) 
{
...
void RaknetTut1_Client::onUpdate(float a_deltaTime) 
{
...
void RaknetTut1_Client::onDestroy()
{
...
int main(int argc, char* argv[])
{
	...
	Application* app = new RaknetTut1_Client();
	
	if (app->create("AIE - RaknetTut1_Client",DEFAULT_SCREENWIDTH,DEFAULT_SCREENHEIGHT,argc,argv) == true)
		app->run();
